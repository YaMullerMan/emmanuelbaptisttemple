...
<footer>
    <div class="footer page-width flex">
        ...
        <div class="footer-right flex">
            <div class="footer-item flex">
                <a href="https://www.facebook.com/EBTHagerstown">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        shape-rendering="geometricPrecision"
                        text-rendering="geometricPrecision"
                        image-rendering="optimizeQuality" fill-rule="evenodd"
                        clip-rule="evenodd" width="40" height="40"
                ...
                <a
                    href="https://www.instagram.com/emmanuelbaptisttemple?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        shape-rendering="geometricPrecision"
                        text-rendering="geometricPrecision"
                        image-rendering="optimizeQuality" fill-rule="evenodd"
            ...
            <div class="footer-item">
                <p><b>Service Times:</b><br>
                    Sundays - 10:45 AM & 6PM<br>
                    Wednesdays - 7:00PM<br><br>
                    301-582-0378<br><br>
                    16221 National Pike<br>
                    Hagerstown, MD 21767<br>
                </p>
            </div>
        </div>
    </div>
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/slider-fade.js">
</script>
<?php wp_footer(); ?>
</body>
